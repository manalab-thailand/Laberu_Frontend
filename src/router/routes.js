const routes = [
    {
        ...
        children: [
            ...
            // { path: '/home', name: "home", component: () => import('pages/Home.vue'), meta: { authRequired: true } },
            // { path: '/anno', name: "annotation", component: () => import('pages/annotation.vue'), meta: { authRequired: true } },
            // { path: '/label', name: "label", component: () => import('pages/Labelling.vue'), meta: { authRequired: true } },
